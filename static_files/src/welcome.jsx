				...
				<Grid item xs={12} sm={4}>
					<Paper elevation={3}>
						<Grid container spacing={3}>
							...
							<Grid item xs={12}>
								<Typography variant="h5">
									Birthday: {this.props.parentState.birthday}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h5">
									Year: {this.props.parentState.year}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h5">
									Lecture: {this.props.parentState.lecture}
								</Typography>
							</Grid>
						</Grid>
					</Paper>
						...
						<Grid container spacing={3}>
							...
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[0]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[1]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[2]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[3]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[4]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[5]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[6]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[7]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[8]}
								</Typography>
							</Grid>
							<Grid item xs={12}>
								<Typography variant="h6">
									{this.props.parentState.top10[9]}
								</Typography>
							</Grid>
						</Grid>
					</Paper>
